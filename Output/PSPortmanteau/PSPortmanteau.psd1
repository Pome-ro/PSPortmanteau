#
# Module manifest for module 'PSPortmanteau'
#
...
FunctionsToExport = 'birthday', 'divider', 'firstname', 'Generate', 'lastname', 'middlename', 
               'New-PSPUserObject', 'randomchar', 'RawText', 'UserID'
